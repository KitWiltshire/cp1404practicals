...
big_full_names = [full_name for full_name in full_names if len(full_name) > 11]
last_names_in_big_full_names = [last_name.split()[1] for last_name in big_full_names]
print(", ".join(last_names_in_big_full_names))
